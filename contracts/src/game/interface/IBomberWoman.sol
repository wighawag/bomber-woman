...
interface IBomberWomanReveal is UsingBomberWomanTypes, UsingBomberWomanEvents {
    ...
    ///  Note that this require the BomberWoman contract to have enough allowance.
...
interface IBomberWomanPoke is UsingBomberWomanTypes, UsingBomberWomanEvents {
