...
contract BomberWomanERC721 is
    IERC721,
    IERC721Metadata,
    IERC721WithBlocknumber,
    UsingBomberWomanSetters,
    ...
    function tokenURI(uint256 tokenID) external view returns (string memory) {
        ...
        return
            string.concat(
                ...
                ",",
                data.y,
                ')","description":"A%20Piece%20Of%20Land%20In%20BomberWoman,%20An%20Autonomous%20World%20Created%20By%20Players.","image":"',
                svgURI,
                '"}'
            );
    }
