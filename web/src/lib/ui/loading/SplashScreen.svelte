...
{#if $splash && $splash.stage === 1}
	...
	<div class="overlay bomberWoman" out:fade on:click={() => splash.nextStage()}>
		<div class="content">
			<img src={url('/title.png')} alt="BomberWoman title" on:load={() => splash.gameLogoReady()} />
