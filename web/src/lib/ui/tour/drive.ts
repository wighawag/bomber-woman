		...
		steps: [
			...
			},
			{
				...
				popover: {
					title: 'The Info bar',
					description:
						'BomberWoman is a "phase-based" game conssting of a 23h "Commit" phase where you make your moves (place new islands) and a 1h "Reveal" phase that execiute every player action simultaneously. This bar will tell you about your current situation and how much time is left for the next phase.',
				},
			},
			{
				element: '#world-map',
				popover: {
					title: 'The world Map',
					description: `This is the world map and where the game take place. When the tour is over and the commit phase is on, you can place as any islands as you own ${initialContractsInfos.contracts.BomberWoman.linkedData.currency.symbol}. This will popup the "Commit Panel" where you can deposit the token and wait for the next phase.`,
				},
			},
