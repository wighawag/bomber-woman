import {bomberWomanView, type ViewCellData} from '$lib/state/ViewState';
import {account, accountData} from '$lib/blockchain/connection';

import {xyToXYID, Color, type ContractCell} from 'bomber-woman-common';
...
export class ActionHandler {
	onCellClicked(x: number, y: number) {
		...
		const currentState = get(bomberWomanView);
